...
public class BestBuyUtils {
    ...
    public void stateSelect() {
    	WebElement element = driver.findElement(By.xpath("(//img[@alt='United States'])[1]"));
    ...
    public void dropDownSelectByValue(WebElement element,String value) {
		...
		sel.selectByValue(value);//dropDownSelectByValue(dropDown,"Arizona");
	}
